package org.apache.spark.pacman.cmr_20191231
...
case class IA[T](idx: IndexedSeq[Long], data: Array[T])

class CmrContext {
  //////////////////////////////// Operations /////////////////////////////////////////////
  def generate[V](numPartitions: Int, genOp: Int=>Array[V]): DS[V] = ???
  def mapPartitions[U, V](u: DS[U], mapOp: Array[U] => Array[V]): DS[V] = ???
  def zipPartitions[U1, U2, V](u1: DS[U1], u2: DS[U2], zipOp: (Array[U1], Array[U2]) => Array[V]): DS[V] = ???
  def exchange[U, V, I](u: DS[U], mapOp: Array[U] => IA[I], reduceOp: IA[I]=>Array[V], numPartitions: Int): DS[V] = ???
